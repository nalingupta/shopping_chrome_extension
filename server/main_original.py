...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            if mtype not in ["imageFrame", "audioChunk", "transcript", "text", "control", "init", "links"]:
            ...
            if mtype == "init":
                ...
                # Handle product links detected by the shopping extension
                try:
                ...
                await _send_json_safe(websocket, {"type": "ack", "seq": seq, "ackType": "links"})
            else:
